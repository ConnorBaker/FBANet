...
parser.add_argument(
    "--src_dir", default="../SIDD_Medium_Srgb/Data", type=str, help="Directory for full resolution images"
)
parser.add_argument(
    "--tar_dir", default="../datasets/denoising/sidd/train", type=str, help="Directory for image patches"
)

...
from ManualDataset import ManualDatasets_validation
from torch.utils.data import DataLoader
from torchvision.transforms import transforms
from tqdm import tqdm
from utils.image_utils import myLPIPS, mySSIM

parser = argparse.ArgumentParser(description="RGB super-resolution test")
parser.add_argument(
    "--input_dir", default="/userhome/aimia/sunyj/Dataset/DRealBSR_RGB", type=str, help="Directory of validation images"
)
parser.add_argument("--result_dir", default="./results/Motion_MFSR_same_0.0/", type=str, help="Directory for results")
parser.add_argument(
    "--weights",
    default="/userhome/aimia/sunyj/FBANet_20230910/pretrained/model_best.pth",
    type=str,

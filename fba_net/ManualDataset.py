...
class ManualDatasets(torch.utils.data.Dataset):
    ...
    def __init__(
        self, root, crop_sz=64, burst_size=14, center_crop=False, random_flip=False, sift_lr=False, split="train"
    ):
        """
        args:
    ...
    def _get_raw_image(self, burst_id, im_id):
        ...
        path = "{}/{}/{}_MFSR_Sony_{:04d}_x1_{:02d}.png".format(
    ...
    def _get_gt_image(self, burst_id):
        ...
        path = "{}/{}/{}_MFSR_Sony_{:04d}_x4.png".format(
...
class ManualDatasets_test(torch.utils.data.Dataset):
    ...
    def __init__(self, root, burst_size=14, center_crop=False, random_flip=False, sift_lr=False, split="train"):
        """
        args:
            root : path of the root directory
            burst_size : Burst size. Maximum allowed burst size is 14.
    ...
    def _get_raw_image(self, burst_id, im_id):
        ...
        path = "{}/{}/MFSR_Sony_{:04d}_x1_{:02d}.png".format(
            self.lrdir, self.burst_list[burst_id], burst_number2, im_id
        )
